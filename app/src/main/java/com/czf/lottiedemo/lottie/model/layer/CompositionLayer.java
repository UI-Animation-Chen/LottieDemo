...
public class CompositionLayer extends BaseLayer {
    ...
    public CompositionLayer(LottieDrawable lottieDrawable, Layer layerModel, List<Layer> layerModels,
                            LottieComposition composition, Context context) {
        ...
        for (int i = layerModels.size() - 1; i >= 0; i--) {
            ...
            BaseLayer layer = BaseLayer.forModel(this, lm, lottieDrawable, composition, context);
            if (layer == null) {
                continue;
            }
            ...
            if (mattedLayer != null) {
                ...
                Layer.MatteType matteType = lm.getMatteType();
                if (matteType == null) {
                    continue;
                }
                switch (matteType) {
