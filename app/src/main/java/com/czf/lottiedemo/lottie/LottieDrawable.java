...
import com.czf.lottiedemo.lottie.animation.LPaint;
import com.czf.lottiedemo.lottie.manager.FontAssetManager;
import com.czf.lottiedemo.lottie.manager.ImageAssetManager;
...
import com.czf.lottiedemo.lottie.parser.LayerParser;
import com.czf.lottiedemo.lottie.utils.Logger;
import com.czf.lottiedemo.lottie.utils.LottieValueAnimator;
...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public boolean enableMergePathsForKitKatAndAbove(Context context) {
     ...
     */
    public boolean setComposition(LottieComposition composition, Context context) {
    ...
    private void buildCompositionLayer(Context context) {
        LottieComposition composition = this.composition;
        if (composition == null) {
            return;
        }
        compositionLayer = new CompositionLayer(
                this, LayerParser.parse(composition), composition.getLayers(), composition, context);
     ...
     * {@link com.czf.lottiedemo.lottie.utils.Utils#getAnimationScale(Context)} is 0.
     */
